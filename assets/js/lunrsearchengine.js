...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>Nenhhum resultado encontrado...</li>";
        }
    }
    return false;
}
...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>Desculpe, nenhum resultado encontrado. Feche e tente outra pesquisa!</li>";
        }
    }
    return false;
}
